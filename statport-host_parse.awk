...
# Current mbps
 if ((NF==14)&&($3=="r")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=rmbpscur value="$7/1024" "ts);t++;}
 if ((NF==14)&&($3=="w")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=wmbpscur value="$7/1024" "ts);t++;}
 if ((NF==14)&&($3=="t")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=tmbpscur value="$7/1024" "ts);t++;}

# Avg mbps
 if ((NF==14)&&($3=="r")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=rmbpsavg value="$8/1024" "ts);t++;}
 if ((NF==14)&&($3=="w")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=wmbpsavg value="$8/1024" "ts);t++;}
 if ((NF==14)&&($3=="t")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=tmbpsavg value="$8/1024" "ts);t++;}

# Max mbps
 if ((NF==14)&&($3=="r")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=rmbpsmax value="$9/1024" "ts);t++;}
 if ((NF==14)&&($3=="w")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=wmbpsmax value="$9/1024" "ts);t++;}
 if ((NF==14)&&($3=="t")) {printf("HstPortMbps,%s,%s\n","HostPort="$1,"type=tmbpsmax value="$9/1024" "ts);t++;}

# Current service times
 if ((NF==14)&&($3=="r")) {printf("HstPortSvt,%s,%s\n","HostPort="$1,"type=rsvtcur value="$10" "ts);t++;}
 if ((NF==14)&&($3=="w")) {printf("HstPortSvt,%s,%s\n","HostPort="$1,"type=wsvtcur value="$10" "ts);t++;}
 if ((NF==14)&&($3=="t")) {printf("HstPortSvt,%s,%s\n","HostPort="$1,"type=tsvtcur value="$10" "ts);t++;}
...
# Qlen
 if ((NF==14)&&($3=="t")) {printf("HstPortQlen,%s,%s\n","HostPort="$1,"type=qlen value="$14" "ts);t++;}
}
