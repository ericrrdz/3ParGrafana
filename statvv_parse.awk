...
# Current service times
 ...
 if ((NF==13)&&($2=="w")&&($3>0)) {printf("VvSvt,%s,%s\n","Vv="$1,"type=wsvtcur value="$9" "ts);t++;}
 if ((NF==13)&&($2=="t")&&($3>0)) {printf("VvSvt,%s,%s\n","Vv="$1,"type=tsvtcur value="$9" "ts);t++;}
...
# Current IO size
 if ((NF==13)&&($2=="r")&&($3>0)) {printf("VvIosz,%s,%s\n","Vv="$1,"type=rioszcur value="$11" "ts);t++;}
 if ((NF==13)&&($2=="w")&&($3>0)) {printf("VvIosz,%s,%s\n","Vv="$1,"type=wioszcur value="$11" "ts);t++;}
 if ((NF==13)&&($2=="t")&&($3>0)) {printf("VvIosz,%s,%s\n","Vv="$1,"type=tioszcur value="$11" "ts);t++;}
...
# Qlen
 if ((NF==13)&&($2=="t")&&($3>0)) {printf("VvQlen,%s,%s\n","Vv="$1,"type=qlen value="$13" "ts);t++;}
}
